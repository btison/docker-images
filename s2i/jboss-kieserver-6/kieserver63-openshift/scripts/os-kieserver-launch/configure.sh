...
pushd "$ADDED_DIR" &> /dev/null
    ...
    chmod ug+x kieserver-config.sh kieserver-install.sh kieserver-pull.sh kieserver-verify.sh kieserver-launch.sh
...
# supplementary tools exists in kieserver 6.3 but not 6.2
