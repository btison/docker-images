...
# 6.3 versions
os63KieVer="1.1.0.Final-redhat-1"
bpm63BaseVer="6.3.4.GA"
bpm63PatchVer="6.3.4"

if [ -e "${SOURCES_DIR}/jboss-bpmsuite-${bpm63BaseVer}-deployable-eap6.x.zip" ]; then
    OS_KIE_VER="${os63KieVer}"
    unzip -q ${SOURCES_DIR}/jboss-bpmsuite-${bpm63BaseVer}-deployable-eap6.x.zip ${KIE_SERVER_WAR_PATH}
    # only install patch over this version
    BPMSUITE_PATCH_DIR="jboss-bpmsuite-${bpm63PatchVer}-patch"
...
cp -f -p ${SOURCES_DIR}/openshift-kieserver-common-${OS_KIE_VER}.jar ${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-common-${OS_KIE_VER}.jar
cp -f -p ${SOURCES_DIR}/openshift-kieserver-jms-${OS_KIE_VER}.jar ${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-jms-${OS_KIE_VER}.jar
cp -f -p ${SOURCES_DIR}/openshift-kieserver-web-${OS_KIE_VER}.jar ${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-web-${OS_KIE_VER}.jar
chmod 664 "${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-common-${OS_KIE_VER}.jar"
chmod 664 "${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-jms-${OS_KIE_VER}.jar"
chmod 664 "${KIE_SERVER_WEBINF_DIR}/lib/openshift-kieserver-web-${OS_KIE_VER}.jar"
