...
The image uses FSW 6.0.0.GA, with Fuse Service Works 6.0.0 Rollup Patch 3 applied

Prerequisites:

* FSW installer (jboss-fsw-installer-6.0.0.GA-redhat-4.jar) in `resources` directory.
* Fuse Service Works 6.0.0 Rollup Patch 2 (BZ-1120384.zip) in `resources` directory.
