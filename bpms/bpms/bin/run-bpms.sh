...
function dumpEnv() {
  ...
  echo "EXECUTOR_RETRY_INTERVAL: ${EXECUTOR_RETRY_INTERVAL}"
  echo "EXECUTOR_RETRY_TIMEUNIT: ${EXECUTOR_RETRY_TIMEUNIT}"
...
EXECUTOR_RETRY_INTERVAL=${EXECUTOR_RETRY_INTERVAL:-3}
EXECUTOR_RETRY_TIMEUNIT=${EXECUTOR_RETRY_TIMEUNIT:-SECONDS}
...
BPMS_OPTS="$BPMS_OPTS -Dorg.kie.executor.interval=${EXECUTOR_RETRY_INTERVAL}"
BPMS_OPTS="$BPMS_OPTS -Dorg.kie.executor.timeunit=${EXECUTOR_RETRY_TIMEUNIT}"
